        ...
        <div className="about__content">
          ...
          <div>
            ...
            <p className="about__description">
              ...
              unfamiliar territory, I enjoy exploring the possibilities of tech
              and constantly expanding what I know.
            </p>
          </div>
          <div>
            ...
            <p className="about__description">
              ...
              dynamic user interfaces. I’ve also worked on cross-platform mobile
              ...
              and other projects, I’ve developed a strong foundation in clean
              code practices, component-driven design, and effective teamwork.
            </p>
          </div>
          <div>
            ...
            <p className="about__description">
              ...
              vision to help Nigeria and the wider African continent unlock
              their full potential in the tech space. That curiosity that makes
              you ask “how does this work?” is what keeps me learning, building,
              and pushing forward. My ultimate goal is to play a role in shaping
              innovative solutions that make a real difference in people’s
              lives.
            </p>
          </div>
